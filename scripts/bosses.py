...
from scripts.settings import WHITE, BOSS_PROJ_COLOUR,  draw_text
...
class Boss1(Boss):
  ...
  def handle_shoot(self):
    if self.curr_state == "attack":
      ...
      if self.cooldown > 1:
        self.projectiles.append(Projectile((self.rect.centerx, self.rect.centery), random.uniform(-3.14, 3.14), BOSS_PROJ_COLOUR, 25))
        self.cooldown = 0
